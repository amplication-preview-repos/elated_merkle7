...
@InputType()
class EnrollmentCreateNestedManyWithoutClassModelsInput {
...
export { EnrollmentCreateNestedManyWithoutClassModelsInput as EnrollmentCreateNestedManyWithoutClassModelsInput };
